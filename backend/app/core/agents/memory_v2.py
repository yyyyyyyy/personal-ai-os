"""Memory System v2 — schema-based user model with confidence, time decay, and conflict resolution.

Replaces the passive embedding-only approach with structured user profiles.
"""
